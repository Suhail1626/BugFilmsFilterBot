...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001902537144 -1002179921548').split()]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://fu19w1ko:kjrNSVZn0MY8qy7y@cluster0.whqp4lj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
MAX_B_TN = int(environ.get("MAX_B_TN", 6))
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CC_MoviesDiccussion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CinemaColonyLinks')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CC_MoviesDiccussion')
